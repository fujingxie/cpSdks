...
public class KeepAliveMessageFactoryImpl implements KeepAliveMessageFactory{
	//心跳包内容
    private static final String HEARTBEATREQUEST = "HeatBeatAck";
    ...
    public boolean isRequest(IoSession session, Object message) {
    	if(message.getClass()==String.class) {
    		Object obj = WcdmaDataHelper.parseData((String)message);
    		 ReporBean bean = (ReporBean) obj;
    		 if (obj!=null&&obj.getClass() == ReporBean.class&&
    				 WcdmaDataHelper.HeartBeatAck_IndiId.equalsIgnoreCase(bean.getIndiNum()) ) {
    			 return true;
    		 }
    	}
